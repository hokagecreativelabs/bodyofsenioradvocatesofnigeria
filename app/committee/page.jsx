  ...
  const CommitteeContent = ({ committee, index }) => (
    <div className="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden mb-8">
      ...
      <div className="p-6">
        {/* Description */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-[#0F2C59] mb-3">About this Committee</h3>
          <p className="text-gray-700">{committee.description}</p>
        </div>
        
        {/* Members List */}
        <div>
          <h3 className="text-lg font-semibold text-[#0F2C59] mb-4">Committee Structure</h3>
    ...
    <>
      ...
      <div className="min-h-screen bg-white p-4 md:p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-[#0F2C59]">BOSAN Committees</h1>
            ...
            <div className="border-b border-gray-200">
              <div className="flex -mb-px">
                {committees.map((committee, index) => (
                  ...
                  >
                    <span className="mr-2 text-[#0F2C59]">{committee.icon}</span>
                    {committee.title}
                  </button>
                ))}
              </div>
