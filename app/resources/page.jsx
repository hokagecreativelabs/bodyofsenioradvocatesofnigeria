...
export default function ResourcesPage() {
  return (
    <div className="p-6 min-h-screen">
      <h2 className="text-2xl font-bold text-[#0F2C59] mb-6">BOSAN Resources</h2>
      <div className="grid md:grid-cols-2 gap-4">
        {resources.map((res) => (
          <div key={res.id} className="border rounded-xl p-4 shadow-md bg-white flex items-center gap-4">
